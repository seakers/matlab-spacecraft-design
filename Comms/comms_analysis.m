function Cost=comms_analysis(params,vars)
...
if optfound
    ...
    components(1) = struct('Name','Filters/Diplexers','Subsystem','Comms','Shape','Rectangle','Mass',massFiltersDiplexers,'Dim',dimFiltersDiplexers,'CG_XYZ',[],'Vertices',[],'LocationReq','Inside','Orientation',[],'Thermal',[-40,100]);
    components(2) = struct('Name','Electronics/Wiring','Subsystem','Comms','Shape','Rectangle','Mass',massElectronics,'Dim',dimElectronics,'CG_XYZ',[],'Vertices',[],'LocationReq','Inside','Orientation',[],'Thermal',[-40,100]);
    
    if strcmp(AntennaTypeOPT,'Parabolic')
        components(3) = struct('Name','Antenna','Subsystem','Comms','Shape','Cilinder','Mass',massAntenna,'Dim',dimAntenna,'CG_XYZ',[],'Vertices',[],'LocationReq','Outside','Orientation',[],'Thermal',[-40,100]);
    else
        components(3) = struct('Name','Antenna','Subsystem','Comms','Shape','Rectangle','Mass',massAntenna,'Dim',dimAntenna,'CG_XYZ',[],'Vertices',[],'LocationReq','Outside','Orientation',[],'Thermal',[-40,100]);
    end

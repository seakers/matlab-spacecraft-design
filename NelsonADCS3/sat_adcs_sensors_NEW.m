...
if N_Magnet > 0
    ...
    power_magnet = magnet_num(best_i,3);
...
if N_Earth > 0
    ...
    power_earth = earth_num(best_i,3);
...
power_allSensors = power_sun + power_earth + power_star + power_magnet;
...
sat_out.SensorPower = power_allSensors;

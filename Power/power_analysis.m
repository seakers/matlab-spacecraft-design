function Cost=power_analysis(params,vars)
    %params:h,lifetime 
    Asa=vars(1);
    icell=vars(2);
    ibat=vars(3);
    ...
    components(1) = struct('Name','Solar Panel','Subsystem','EPS','Shape','Rectangle','Mass',Msa,'Dim',[L,W,H],'CG_XYZ',[],'Vertices',[],'LocationReq','Outside','Orientation',[],'Thermal',[-40,100]);
    components(2) = struct('Name','Battery','Subsystem','EPS','Shape','Rectangle','Mass',Mbatt,'Dim',[dimbat,dimbat,dimbat],'CG_XYZ',[],'Vertices',[],'LocationReq','Inside','Orientation',[],'Thermal',[-40,100]);

...
sat.ThrusterMomentArm       = 0.5;          % Moment Arm for calculation of thrusters' torque. Aixo ha de venir d'structures
...
sat.Iyy=60;%structures
sat.Izz=90;%structures
sat.SurfaceArea=3;%structures

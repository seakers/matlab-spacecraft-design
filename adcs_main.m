function [adcs]=adcs_main(h,pointingaccuracy,slewDuration,slewAngle,Iyy,Izz,SurfaceArea)
...
sat.ADCSChoice		        = 1;            % 1: ADCS from a catalogue 2: make ADCS subsystem
...
%set sensors used based on pointing accuracy
if sat.MaxPointingADCS > 5
    sat.NumberofSunSensors      = 0;            % Number of sun sensors(>=2) [#]
    sat.NumberofStarTrackers    = 0;
    sat.NumberofEarthSensors    = 0;
    sat.NumberofMagnetometers   = 0;
    sat.NumberofMagneticTorquers = 0;
    sat.NumberofRW = 0;
    sat.NumberofThrusters = 0;
elseif sat.MaxPointingADCS > 1
    sat.NumberofSunSensors      = 0;            % Number of sun sensors(>=2) [#]
    sat.NumberofStarTrackers    = 0;
    sat.NumberofEarthSensors    = 0;
    ...
    sat.NumberofRW = 0;
    sat.NumberofThrusters = 0;
elseif sat.MaxPointingADCS > 0.1
    sat.NumberofSunSensors      = 0;
    sat.NumberofStarTrackers    = 0;
    ...
    sat.NumberofRW = 3;
    sat.NumberofThrusters = 0;
elseif sat.MaxPointingADCS > 0.0166667
    sat.NumberofSunSensors      = 2;
    sat.NumberofStarTrackers    = 0;
    sat.NumberofEarthSensors    = 1;
    sat.NumberofMagnetometers   = 2;
    sat.NumberofMagneticTorquers = 3;
...
sat.InTheaterAccessDuration = slewDuration;           % duration of slewing maneuver [s]
sat.MaxPointing= slewAngle;                        % Maximum slewing angle [degrees]
